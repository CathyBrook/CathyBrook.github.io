...
<div class="row">
    <div class="col-sm-12 clearfix">
        ...
        <div class="row">
            <div class="col-12">
                <div class="content">
                    <p>I am actively seeking motivated students for research opportunities. DOE national labs provide several student programs and potential research aide positions available for undergraduate, master's, and PhD students. Please contact me <a href="mailto:juanjuan.huang@anl.gov"><i class="fa-solid fa-envelope"></i></a> for more information if you are interested in potential opportunities.</p>
                    <p>I am currently looking for potential students in the following areas:</p>
                    <ul style="list-style: none; padding-left: 0;">
                        <li style="margin-bottom: 10px;"><i class="fa-solid fa-database" style="color: #3b0f70; margin-right: 10px;"></i> X-ray spectroscopy benchmark & datasets</li>
                        ...
                        <li style="margin-bottom: 10px;"><i class="fa-solid fa-pen-ruler" style="color: #de4968; margin-right: 10px;"></i> ms-scale X-ray spectroscopy instrumentation CAD design</li>
