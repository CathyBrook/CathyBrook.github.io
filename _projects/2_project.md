...
img: assets/img/gallery/gallery_2p-3d-rixs.png
importance: 2
category: work
...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        {% include figure.liquid loading="eager" path="assets/img/gallery/gallery_2p-3d-rixs.png" title="example image" class="img-fluid rounded z-depth-1" %}
    </div>
</div>
<div class="caption">
